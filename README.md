...
### 🧭 [0x01 · 哲学理念 — 道](./0x01_哲学理念)

> **道层** —— 体系的本源认知,回答「为什么」

- [知行合一 · 上下相济 · 循环演进 —— 软件架构与人机协同的哲学体系](./0x01_哲学理念/0x01_架构设计哲学.md)

### 📐 [0xA0 · 实践方法 — 法](./0xA0_实践方法)

> **法层** —— 可落地的工程方法论,回答「怎么做」

- [架构设计入门指南](./0xA0_实践方法/0xA1_架构设计入门指南.md) —— 从业务到部署的设计逻辑链
- [人机协同开发流程(Vibe Coding)](./0xA0_实践方法/0xA2_人机协同开发流程.md) —— AI 时代的开发心法
- [团队协作落地手册](./0xA0_实践方法/0xA3_团队协作落地手册.md) —— DDD + TDD + SDD 三位一体
- [代码质量评估体系](./0xA0_实践方法/0xA4_代码质量评估体系.md) —— 量化、可对比、可治理

### 🧱 [0xB0 · 实践模式 — 器](./0xB0_实践模式)

> **术层** —— 经过验证的可复用工程模式

- [DDD + 多租户架构模式](./0xB0_实践模式/0xB1_DDD多租户架构模式.md) —— 框架核心模式提炼
