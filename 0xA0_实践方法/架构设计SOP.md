...
> **延伸阅读**
>
> - [架构设计哲学](../0x01_哲学理念/架构设计哲学.md) —— SOP 背后的"道"
> - [架构设计入门指南](./架构设计入门指南.md) —— 与本 SOP 互补的"心法"
> - [DDD + 多租户架构模式](../0xC0_实践模式/DDD多租户架构模式.md) —— 10 节模板背后的工程模式
> - [团队协作开发指南](./团队协作开发指南.md) —— DDD + TDD + SDD 怎么协同
