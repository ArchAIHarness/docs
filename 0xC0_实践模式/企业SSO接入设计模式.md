...
> **前置阅读**:[架构设计哲学](../0x01_哲学理念/架构设计哲学.md) · [DDD 多租户架构模式](./DDD多租户架构模式.md)
...
> **延伸阅读**
> - [DDD + 多租户架构模式](./DDD多租户架构模式.md) —— `tenantCode` 在领域模型中的落地
> - [ArchAIHarness Gateway](https://github.com/ArchAIHarness/gateway) —— 反应式网关与 SSO Provider 同源
> - [架构设计入门指南](../0xA0_实践方法/架构设计入门指南.md) —— "接口契约先行"在身份认证场景的应用
